...
namespace EFProject
{
    public partial class FrmStatistics: Form
    {
        ...
        private void FrmStatistics_Load(object sender, EventArgs e)
        {
            ...
            int lastLocationId = db.Location.OrderByDescending(x => x.LocationId).FirstOrDefault().LocationId;
            lblLastCountry.Text = db.Location.Where(x => x.LocationId == lastLocationId).FirstOrDefault().Country;
